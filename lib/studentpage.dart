      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const<BottomNavigationBarItem> [
          ...
          BottomNavigationBarItem(
            ...
            title: Text('Chat',style: TextStyle(color: Colors.red)),
          )
        ],
      ),
      body: Container(
          ...
          children: [
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  Text("Hi Eslam",style: TextStyle(fontSize: 30.0 , fontWeight: FontWeight.w800 )),
                  Text("Your Subject" , style: TextStyle(fontSize: 20.0 ,  )),
                ],
              ),
            ),
            Container(
                ...
                children: [
                  InkWell(onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (BuildContext context){
                      ...
                      child: Text("My Homework" , style: TextStyle(fontSize: 20.0 ,  ))),
                ],
              ),
            ),
            SizedBox(
